...
public class SAMDownloadManager {
	
	protected String URL_FILE;

	private static final String TAG = null;
	protected static SAMDownloadManager mInstance;
	...
	public synchronized static SAMDownloadManager getInstance(Context context) {
		if (mInstance == null)
			mInstance = new SAMDownloadManager(context);
	...
	public SAMDownloadManager(Context context, IDownloadNotifier notifier) {
	...
	public SAMDownloadManager(Context context) {
	...
	public boolean initializeDownload(String url){
		...
		if(d != null){
			...
			SAMManager.SoundPath = soundFilePath;
	...
	private void CheckDwnloadStatus(){
		...
		if(cursor.moveToFirst()){
			...
			switch(status){
				...
				notifier.onErrorDownload();
				Log.e(SAMDownloadManager.class.getSimpleName(), "FAILED: " + failedReason);
//				Toast.makeText(context, "FAILED: " + failedReason, Toast.LENGTH_LONG).show();
				...
				Log.e(SAMDownloadManager.class.getSimpleName(), "PAUSED: " + pausedReason);
//				Toast.makeText(context, "PAUSED: " + pausedReason,Toast.LENGTH_LONG).show();
				...
				case DownloadManager.STATUS_SUCCESSFUL:
					...
					Log.e(SAMDownloadManager.class.getSimpleName(), "SUCCESSFUL");
